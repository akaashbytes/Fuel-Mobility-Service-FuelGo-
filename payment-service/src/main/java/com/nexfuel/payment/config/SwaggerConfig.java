package com.nexfuel.payment.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("NexFuel Payment Microservice API")
                        .version("1.0.0")
                        .description("REST API documentation for NexFuel invoicing, payment transactions processing, provider settlement payouts, and ledger journals bookkeeping.")
                        .contact(new Contact()
