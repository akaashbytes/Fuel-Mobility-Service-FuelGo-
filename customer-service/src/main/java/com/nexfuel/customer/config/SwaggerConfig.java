package com.nexfuel.customer.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("NexFuel Customer Microservice API")
                        .version("1.0.0")
                        .description("REST API documentation for the NexFuel Customer profiles and vehicles service.")
                        .contact(new Contact()
