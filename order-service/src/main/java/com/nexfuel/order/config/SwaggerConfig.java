package com.nexfuel.order.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("NexFuel Order Microservice API")
                        .version("1.0.0")
                        .description("REST API documentation for the NexFuel Order creation, routing, assignments, state transitions, and OTP verification.")
                        .contact(new Contact()
