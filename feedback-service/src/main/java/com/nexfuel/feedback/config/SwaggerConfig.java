package com.nexfuel.feedback.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("NexFuel Feedback Microservice API")
                        .version("1.0.0")
                        .description("REST API documentation for customer review submissions, provider ratings logs, administrative responses, and metrics dashboards.")
                        .contact(new Contact()
