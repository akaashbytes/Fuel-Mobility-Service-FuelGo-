package com.nexfuel.collaborator.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("NexFuel Collaborator Microservice API")
                        .version("1.0.0")
                        .description("REST API documentation for the NexFuel Collaborator stations, pricing, and regional service areas coverage.")
                        .contact(new Contact()
