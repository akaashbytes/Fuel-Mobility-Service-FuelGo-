...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        .title("NexFuel Tracking & Logistics Microservice API")
                        .version("1.0.0")
                        .description("REST API documentation for provider location tracking, customer order ETA timelines, alert broadcast distributions, and maps dashboards using MongoDB.")
                        .contact(new Contact()
